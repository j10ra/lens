					...
					{selected && (
						<>
							<SheetHeader>
								...
								<SheetDescription>
									<span className={STATUS_COLORS[String(selected.status)[0]] ?? ""}>
										{selected.status}
									</span>
									{" · "}
									...
									{" · "}
									<span className={`inline-block rounded px-1 py-0.5 text-[10px] font-medium ${SOURCE_COLORS[selected.source] ?? ""}`}>
										{selected.source}
									</span>
								</SheetDescription>
							</SheetHeader>
